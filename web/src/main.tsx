...
const ErrorFallback = () => (
  <div className="dark:bg-fmd-dark-lighter flex min-h-screen flex-col items-center justify-center bg-white px-4 text-center">
    <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-white">Something went wrong</h1>
    <p className="mb-8 text-lg text-gray-600 dark:text-gray-400">An unexpected error occurred</p>
    <button
