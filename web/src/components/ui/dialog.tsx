    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close
          ...
          className="focus-visible:ring-ring absolute top-4 right-4 cursor-pointer rounded-md p-1.5 opacity-70 transition-all hover:bg-gray-100 hover:opacity-100 focus:opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none dark:hover:bg-white/[0.08] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
        >
          <XIcon />
